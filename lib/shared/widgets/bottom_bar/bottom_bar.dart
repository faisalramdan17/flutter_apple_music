...
class XBottomBar extends StatefulWidget {
  XBottomBar({
    ...
    this.tilesPadding = EdgeInsets.zero,
        ...
        assert(
          items.every((XBottomBarItem item) => item.title != null) == true,
  ...
  final List<XBottomBarItem> items;
...
class _BottomNavigationBarState extends State<XBottomBar>
...
//  Animatable<double> _flexTween = widget.hasNotch ? Tween<double>(begin: 1.15, end: 2.0) : Tween<double>(begin: 1.15, end: 1.75);
  ...
  @override
  void didUpdateWidget(XBottomBar oldWidget) {
    ...
    if (widget.currentIndex != oldWidget.currentIndex) {
      ...
      if (widget.fabLocation == BubbleBottomBarFabLocation.center) {
        XBottomBarItem _currentItem = widget.items[oldWidget.currentIndex!];
        XBottomBarItem _nextItem = widget.items[widget.currentIndex!];
